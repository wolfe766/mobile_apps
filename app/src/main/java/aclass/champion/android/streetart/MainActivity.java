...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button mCreateButton, mReadButton, mUpdateButton, mDeleteButton, mUpdatePictureName, mHomeScreenButton;

        mHomeScreenButton = findViewById(R.id.home_button);
        mCreateButton = findViewById(R.id.create_button);
        mReadButton = findViewById(R.id.read_button);
        mUpdateButton = findViewById(R.id.update_button);
        mDeleteButton = findViewById(R.id.delete_button);
        mUpdatePictureName = findViewById(R.id.change_name_button);
