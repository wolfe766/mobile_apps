...
public class SearchFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mSearchButton = v.findViewById(R.id.search_button1);
            ...
            public void onClick(View v) {
                ...
                mDocRef.get().addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
                    ...
                    public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                        ...
                        mAdapter = new ListAdapter(recyclerInput, getActivity());
...
//        }
    ...
    private void retrievePicturesFromFirebase(final View v){
